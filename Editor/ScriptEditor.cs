...
public class ScriptEditor : EditorWindow
{
    ...
    [MenuItem("Tools/Editor/Script Editor %&e", priority = 2)] // Shortcut [Ctrl + Alt + E]
    ...
    private void DrawLayout()
    {
        ...
        toolTip.x = headerSection.width - 78;
        toolTip.y = headerSection.y + 0;
        toolTip.width = 10;
        toolTip.height = 20;

        saveIndicator.x = headerSection.width - 68;
    ...
    private void DrawContent()
    {
        ...
        codeText = GUILayout.TextArea(codeText, GUILayout.MaxHeight(position.height - 40), GUILayout.ExpandWidth(true), GUILayout.ExpandHeight(true));
    ...
    {
        GUILayout.EndHorizontal();
        if (showFind || showRename) { EditorGUILayout.Space(5); HorizontalLine(Color.grey); EditorGUILayout.Space(5); }
    ...
    {
        GUILayout.EndHorizontal();
        if (showRename) { EditorGUILayout.Space(5); HorizontalLine(Color.grey); EditorGUILayout.Space(5); }
